...
**Available models:** veo, seedance-pro, seedance-2.0, wan, wan-fast, wan-pro, grok-video-pro, grok-imagine-video-1.5, happyhorse-1.1, p-video, nova-reel
...
**Audio models:** elevenlabs, elevenflash, eleven-multilingual-v2, eleven-dialogue, eleven-voice-changer, eleven-voice-isolator, elevenmusic, lyria-3-clip, eleven-sfx, whisper, scribe, grok-transcribe, universal-2, universal-3.5-pro, stable-audio-3-medium, stable-audio-3-large, qwen-tts, qwen-tts-instruct, csm-1b, kokoro
...
| `GET /v0/pipes/app_directory_public.json` | `category`, `platform`, `limit` (1000) | The community app directory ([apps/catalog.json](https://github.com/pollinations/pollinations/blob/main/apps/catalog.json)) |
